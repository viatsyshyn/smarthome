...
export class DraggableDirective implements OnInit {
    ...
    set ngDraggable(setting: any) {
        if (setting !== undefined && setting !== null && setting !== '') {
            ...
            this.renderer.setElementClass(element, 'ng-draggable', this.allowDrag);
        }
    }
    ...
    private pickUp() {
        ...
        if (window) {
            let computed = window.getComputedStyle(this.el.nativeElement, null);
            this.oldZIndex = computed.getPropertyValue('z-index');
            this.oldPosition = computed.getPropertyValue('position');
        }
